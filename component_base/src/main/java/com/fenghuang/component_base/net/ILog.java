...
import com.fenghuang.component_base.BuildConfig;
...
public class ILog {
	...
	private static String LogDirPath = Environment.getExternalStorageDirectory() + ".log";
	...
	public static void wr(String strErrMsg) {
		wr(TAG, strErrMsg);
	}
